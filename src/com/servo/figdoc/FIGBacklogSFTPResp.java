 ...
 */
@TimerService
public class FIGBacklogSFTPResp {
    ...
    public void loadConfigurations(Connection con1) throws NoSuchProviderException, MessagingException {
        try {
            System.out.println("[FIG-BL]-- Inside Post Construct Loading Config.");
            LoadConfig objConfig = new LoadConfig();
            objConfig.readConfig(this.configObj);
            System.out.println("[FIG-BL]--SftpIp - " + this.configObj.getDmsSftpIp());
            System.out.println("[FIG-BL]--SftpUserId - " + this.configObj.getDmsSftpUserId());
            System.out.println("[FIG-BL]--SftpDir - " + this.configObj.getDmsSftpDir());
            ...
            System.out.println("[FIG-BL]-- Post construct Executed Config Loaded For Doc Upload.");
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out.println("[FIG-BL]-- Config Load Exception->" + ex);
        }
    }

    @Execute
    public void execute(Connection con) throws Exception {
        System.out.println("[FIG-BL]--Inside execute Proceeding to Download from SFTP::::");
    ...
    public void initiateSftp(propertyConfig configObj, Connection con) throws JSchException {
        ...
        // Local directory
        String localDirectory = "DMS_ARCHIVAL/FIG/BACKLOG_RESPONSE/";

        System.out.println("[FIG-BL]--SFTP IP: " + serverAddress);
        System.out.println("[FIG-BL]--SFTP USERID: " + userId);
        System.out.println("[FIG-BL]--SFTP PWD: " + password);
        System.out.println("[FIG-BL]--REMOTE: " + remoteDirectory);
        System.out.println("[FIG-BL]--LOCAL: " + localDirectory);
        ...
        try {
            ...
            System.out.println("[FIG-BL]--SFTP URL: " + sftpUri);
            ...
            System.out.println("[FIG-BL]-- DOWNLOAD IS SUCCESSFULL--PROCEEDING TO READ THE FILES.");
            ...
            System.out.println("[FIG-BL]--Exception happened while copying form Sftp: " + ex);
            ex.printStackTrace();
            // Handle exceptions
        } catch (SQLException ex) {
            Logger.getLogger(FIGBacklogSFTPResp.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
    ...
    public void processLocalFiles(String localDirectory, Connection con) throws SQLException {
        try {
            ...
            for (File file : fileList) {
                ...
                System.out.println("[FIG-BL]--FILE TO BE READ: " + file.getName());
                ...
                try (Scanner scanner = new Scanner(file)) {
                    ...
                    if (scanner.hasNextLine()) {
                        ...
                        System.out.println("[FIG-BL]-- DATA IN THE SECOND LINE: " + dataPartscontents);
                        
                        System.out.println("[FIG-BL]--LENGTH OF THE dataParts : " + dataParts.length);
                    ...
                    System.out.println("[FIG-BL]--STATUS: " + status + " REASON: " + reason + "FOR THE CIF: " + cifId);
                }
                ...
                System.out.println("[FIG-BL]--TABLE UPDATE STATUS: " + updateStatus);

                if (updateStatus) {
                    System.out.println("[FIG-BL]-- STATUS IS UPDATED IN THE TABLE SUCCESFULLY FOR THE CIF: " + cifId);
    ...
    public boolean updateDatabase(Connection con, String cifId, String status, String remarks) throws SQLException {
        ...
        try {
            ...
            String sql = "UPDATE FIG_BACKLOG_SFTP SET Status = ?, Remarks = ? WHERE Cifid = ?";
