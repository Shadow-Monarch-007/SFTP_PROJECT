...
public class MBLBacklogSFTP {
    ...
    public void loadConfigurations(Connection con1) throws NoSuchProviderException, MessagingException {
        try {
            System.out.println("[MBL-SFTP-BL]-- Inside Post Construct Loading Config.");
            LoadConfig objConfig = new LoadConfig();
            objConfig.readConfig(configObj);

            System.out.println("[MBL-SFTP-BL]--SftpIp - " + configObj.getDmsSftpIp());
            System.out.println("[MBL-SFTP-BL]--SftpUserId - " + configObj.getDmsSftpUserId());
            System.out.println("[MBL-SFTP-BL]--SftpDir - " + configObj.getDmsSftpDir());
            ...
            System.out.println("[MBL-SFTP-BL]-- Post construct Executed Config Loaded For Doc Upload.");
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out.println("[MBL-SFTP-BL]-- Config Load Exception->" + ex);
        }
    }
    ...
    public void execute(Connection con) throws Exception {
        ...
        int sftpstatus = 0;
        System.out.println("[MBL-SFTP-BL]--MERGE  Start Calling the Docupload");
        ...
        String getDMSUploadSql = "{call MBL_BACKLOG_SFTP_PQ(?,?)}";

        System.out.println("[MBL-SFTP-BL]--INSIDE EXECUTE");
        try {
            ...
            System.out.println("[MBL-SFTP-BL]--MERGE  Dms Upload after getting  --" + configObj.getProcessid());
            ...
            while (rs.next()) {
                ...
                System.out.println("[MBL-SFTP-BL]-- - PROCESSINSTANCEID = " + pinstid);
                ...
                System.out.println("[MBL-SFTP-BL]-- - PROCESSINSTANCEID = " + dataMap.get("PROCESSINSTANCEID"));
                System.out.println("[MBL-SFTP-BL]-- - CUSTOMERID = " + dataMap.get("CUSTOMERID"));
                System.out.println("[MBL-SFTP-BL]-- - FOLDERID = " + dataMap.get("FOLDERID"));
                System.out.println("[MBL-SFTP-BL]-- - ACCOUNTNO = " + dataMap.get("ACCOUNTNO"));

                //else {
                System.out.println("[MBL-SFTP-BL]--PROCEEDING DOCUPLOAD");

                if (pinstid != null && folderId != 0) {

                    System.out.println("[MBL-SFTP-BL]---PINSTID & FOLDER IS IS NOT NULL--PROCEEDING FOR DOCUPLOAD");
                    ...
                    System.out.println("[MBL-SFTP-BL]-- Data Fetched Going to initiate Doc Upload");
                    //if (dataMap.get("TEMPFLAG").toString().equals("")) {
                    String deletecustomerID = dataMap.get("CUSTOMERID").toString();
                    String deletedirectoryPath = "DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP";
                    ...
                    System.out.println("[MBL-SFTP-BL]-- Status:" + Status);
                    ...
                    if (Status == 1) {
                        try {
                            ...
                            String directoryPath = "DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP" + File.separator + "EXT-" + customerID;
// Define the names of the documents to check
                            ...
                            try {
                                ...
                                System.out.println("[MBL-SFTP-BL]-- SELECTING ID PROOF TYPE FOR PINSTID: " + MBL_pinstid);
                                ...
                                try (PreparedStatement pid = con.prepareStatement(idq)) {
                                    ...
                                    try (ResultSet idrs = pid.executeQuery()) {
                                        while (idrs.next()) {
                                            ...
                                            System.out.println("[MBL-SFTP-BL]--ID_PROOF_NUMBER: " + ID_PROOF_NUMBER);
                            ...
                            System.out.println("[MBL-SFTP-BL]--PRIMARYIDPROOF_TYPE: " + idprooftype);

                            String[] documentNames;

                            switch (idprooftype) {
                                case "1": {
                                    System.out.println("[MBL-SFTP-BL]--PRIMARY ID IS AADHAR");
                                    documentNames = new String[]{"Photograph", "Signature", "UID"};
                                    break;
                                }
                                case "2": {
                                    System.out.println("[MBL-SFTP-BL]--PRIMARY ID IS VOTER");
                                    documentNames = new String[]{"Photograph", "Signature", "Voters_Identity_Card"};
                                    break;
                                }
                                case "3": {
                                    System.out.println("[MBL-SFTP-BL]--PRIMARY ID IS Pancard");
                                    documentNames = new String[]{"Photograph", "Signature", "Pancard"};
                                    break;
                                }
                                case "4": {
                                    System.out.println("[MBL-SFTP-BL]--PRIMARY ID IS Driving Licence");
                                    documentNames = new String[]{"Photograph", "Signature", "Driving_License"};
                                    break;
                                }
                                case "6": {
                                    System.out.println("[MBL-SFTP-BL]--PRIMARY ID IS Passport");
                                ...
                                default: {
                                    ...
                                    System.out.println("[MBL-SFTP-BL]--ID TYPE IS NEITHER 1 NOR 2NOW WE CONSIDER PRIMARY ID IS AADHAR");
                                    break;
                                }
                            }
...
// Set the status based on the number of missing documents
                            ...
                            System.out.println("[MBL-SFTP-BL]--String of found documents: " + sftpdocs);
// Print the names of missing documents
                            if (!missingDocuments.isEmpty()) {
                                ...
                                try {
                                    ...
                                    System.out.println("Inserted in to MBL_Ckyc_Sftp");
                                ...
                                if (directory.exists() && directory.isDirectory()) {
                                    ...
                                    if (files != null) {
                                        ...
                                        System.out.println("[MBL-SFTP-BL]--Directory is empty.");
                                    }
                                } else {
                                    System.out.println("[MBL-SFTP-BL]--Directory does not exist or is not a directory.");
                                }
...
// Use the 'status' variable as needed (send it to another method, etc.)
                        ...
                        System.err.println("[MBL-SFTP-BL]--sftpstatus for SFTP initiation: " + sftpstatus);
                        try {
                            MBL_pinstid = String.valueOf(dataMap.get("PROCESSINSTANCEID"));
                            ...
                            switch (sftpstatus) {
                                case 1: {
                                    ...
                                    System.out.println("[MBL-SFTP-BL]--- Proceding For Sftp.");
...
//                                        }
                                    ...
                                    String uquery = "UPDATE MBL_BACKLOG_SFTP SET EXECUTION_FLAG = ?,REMARKS = ?,DOCS_IN_SFTP = ?,PROCESSED_AT = SYSDATE WHERE PROCESSINSTANCEID = ?";
...
//                                        }
                                    ...
                                    String uquery = "UPDATE MBL_BACKLOG_SFTP SET EXECUTION_FLAG = ?,REMARKS = ?,PROCESSED_AT = SYSDATE WHERE PROCESSINSTANCEID = ?";
                                    try (PreparedStatement upstmt = con.prepareStatement(uquery)) {
...
//                                            ipstmt.execute();
//                                        }
                                    String uquery = "UPDATE MBL_BACKLOG_SFTP SET EXECUTION_FLAG = ?,REMARKS = ?,MISSING_DOCS=?,PROCESSED_AT = SYSDATE WHERE PROCESSINSTANCEID = ?";
                                    try (PreparedStatement upstmt = con.prepareStatement(uquery)) {
                                ...
                                default: {
                                    System.out.println("[MBL DOC_EXE Doc Upload] -- SFTP COULDN'T BE INITIATED");
                                    System.err.println("sftpstatus: " + sftpstatus);
                                    String uquery = "UPDATE MBL_BACKLOG_SFTP SET EXECUTION_FLAG = ?,REMARKS = ?,PROCESSED_AT = SYSDATE WHERE PROCESSINSTANCEID = ?";
                                    try (PreparedStatement upstmt = con.prepareStatement(uquery)) {
                                        upstmt.setString(1, "FAIL");
...
//                    System.out.println("[MBL-SFTP-BL]--LOANTYPE_IS NULL");
//
//                }
            }
            ...
            System.out.println("[MBL-SFTP-BL]-- UPDATED MBL_BACKLOG_SFTP: EXCEPTION OCCURED FOR:" + dataMap.get("PROCESSINSTANCEID").toString());

            ex.getCause();
            System.out.println("[MBL-SFTP-BL]--Inside Exception - " + ex);
        } finally {
            closeCallableConnection(rs, callableStatement);
        }
    }
    ...
    public boolean updateDATA(Connection con, String type, Map<String, String> Datamap) {
        ...
        try {
            if (type.equalsIgnoreCase("Fail")) {
                query = "Insert Into MBL_SFTP_FAIL (Pinstid,Cifid,Found_M_Docs,Sftp_Upload_Status,REMARKS,Executed_Time) VALUES(?,?,?,?,?,SYSDATE)";
    ...
    public int initiateDocUpload(Map dataMap, Long folderId, Connection con, String pinstid) {
        ...
        try {
            ...
            nf.setUuid(folderId);
            System.out.println("[MBL-SFTP-BL]-- - sessionId-" + sessionId);
            ...
            if (!sessionId.equals("")) {
                ...
                if (!nodeDoc.isEmpty()) {
                    ...
                    for (NodeDocument nodeD : nodeDoc) {
                        System.out.println("[MBL-SFTP-BL]-- For Loop Started");
                        ...
                        System.out.println("[MBL-SFTP-BL]-- - Doc Name:" + nodeD.getName());

                        System.out.println("[MBL-SFTP-BL]-- - Doc UUID:" + nodeD.getUuid());
                        ...
                        if (nodeD.getName().equalsIgnoreCase("Group Photo.") || nodeD.getName().equalsIgnoreCase("Group Photo")) {
                            ...
                            System.out.println("[MBL-SFTP-BL]-- - Going to extract Docs.");
                            //CH-D-2001
                            String docExtName = dataMap.get("DocName").toString();
                            System.out.println("[MBL-SFTP-BL]-- - docExtName---" + docExtName);
...
//                        }
                    ...
                    System.out.println("[MBL-SFTP-BL]-- For Loop Stopped");
                    System.out.println("[MBL-SFTP-BL]-- All Doc Extracted Initiating C-Kyc");
                    ...
                    try {
                        ...
                        System.out.println("[MBL-SFTP-BL]-- CKYC Update Done");
                        //end
                    } catch (Exception e) {
                        System.out.println("[MBL-SFTP-BL]--com.servo.mbldoc.MBLBacklogSFTP.initiateDocUpload()");
                        updateFlag(con, dataMap.get("PROCESSINSTANCEID").toString(), "EXC", e.getMessage());
                    }
                }

            } else {
                System.out.println("[MBL-SFTP-BL]-- - Session Not Found To Upload Docs");
            }
        } catch (InvalidRepositoryException | PathNotFoundException | IOException ex) {
            updateFlag(con, dataMap.get("PROCESSINSTANCEID").toString(), "EXC", ex.getMessage());
            System.out.println("[MBL-SFTP-BL]-- - EX -" + ex);
    ...
    public int fileOperation(ByteArrayInputStream is, Map dataMap, Connection con) {
        ...
        try {
            ...
            if (!file.exists()) {
                ...
                System.out.println("[MBL-SFTP-BL]-- - Base Directory Created.");
            }

            file = new File("DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP" + File.separator + "EXT-" + dataMap.get("CUSTOMERID"));
            ...
            System.out.println("[MBL-SFTP-BL]---- Extension found- " + extension);
            System.out.println("[MBL-SFTP-BL]---- DocumentName- " + docName);
            //CH-D-2001
            String docExtName = dataMap.get("ProofName").toString();
            String DocTypeName = dataMap.get("CsvName").toString();
            System.out.println("[MBL-SFTP-BL]---- File opertaion docExtName- " + docExtName);
            System.out.println("[MBL-SFTP-BL]---- File opertaion docExtName- " + DocTypeName);
            ...
            if (extension.equalsIgnoreCase("pdf")) {
                ...
                try ( //CH-D-2001
                        ...
                        FileOutputStream fos = new FileOutputStream("DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP" + File.separator + "EXT-" + dataMap.get("CUSTOMERID") + File.separator + docExtName + "." + extension)) {
                    //END
                    fos.write(array);
                }
                File pdffile = new File("DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP" + File.separator + "EXT-" + dataMap.get("CUSTOMERID") + File.separator + docExtName + "." + extension);
                if (pdffile.exists()) {
                    boolean bval = file.setExecutable(true);
                    System.out.println("set the owner's execute permission: " + bval);
                } else {
                ...
                ImageIO.write(bImageFromConvert, extension, new File("DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP" + File.separator + "EXT-" + dataMap.get("CUSTOMERID") + File.separator + docExtName + "." + extension));
                //END

                File Imgfile = new File("DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP" + File.separator + "EXT-" + dataMap.get("CUSTOMERID") + File.separator + docExtName + "." + extension);
                if (Imgfile.exists()) {
                    boolean bval = file.setExecutable(true);
                    System.out.println("set the owner's execute permission: " + bval);
                } else {
            ...
            System.out.println("[MBL-SFTP-BL]-- - Doc Copied To Server Locations--" + DocTypeName);
...
//                writer.close();
//            }
            System.out.println("[MBL-SFTP-BL]-- - Csv Entry Created");
            status = 1;

        } catch (IOException e) {
            updateFlag(con, dataMap.get("PROCESSINSTANCEID").toString(), "EXC", e.getMessage());
            System.out.println("[MBL-SFTP-BL]-- - File writing exe - " + e);
            e.printStackTrace();
            return status;
        }
        return status;
...
//PROD
//String path = System.getProperty("user.dir") + File.separator + "DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP" + File.separator + "EXT-" + dataMap.get("CUSTOMERID");
        String path = System.getProperty("user.dir") + File.separator + "DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP" + File.separator + "EXT-" + dataMap.get("CUSTOMERID");
        try {
            //MY CODE

            Map HashCustProof = getDocuemntsDetails(con, pinstid);
            System.out.println("[MBL-SFTP-BL]--HashCustProof---" + HashCustProof.toString());
            String IdProoftype = HashCustProof.get("IDPROOFTYPE").toString();
            System.out.println("[MBL-SFTP-BL]--IdProoftype---" + IdProoftype);
            String AddressProofType = HashCustProof.get("ADDRESS_PROOF_TYPE").toString();
            System.out.println("[MBL-SFTP-BL]-- IdProoftype---" + AddressProofType);

            System.out.println("[MBL-SFTP-BL]-- Completed the CKYC Documents Chages");

            //end
            File file = new File("DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP" + File.separator + "EXT-" + dataMap.get("CUSTOMERID"));
            System.out.println("[MBL-SFTP-BL]-- - CKyc-- File-" + file.getAbsolutePath());
            configObj.setDmsSftpLocalDir("EXT-" + dataMap.get("CUSTOMERID"));
            System.out.println("[MBL-SFTP-BL]-- - TEMPLOC-- SFTP-" + configObj.getDmsSftpLocalDir());
            dataMap.put("TEMPLOC", configObj.getDmsSftpLocalDir());
            String csv = file.toString() + File.separator + "EXT-" + dataMap.get("CUSTOMERID") + ".csv";
            //writer = new CSVWriter(new FileWriter(csv, true), '|', CSVWriter.NO_QUOTE_CHARACTER);
            System.out.println("[MBL-SFTP-BL]-- - CKyc-- csv file-" + csv);
            ...
            for (String strTemp : arrSplit) {
                ...
                if (testFile.exists()) {
                    ...
                    System.out.println("[MBL-SFTP-BL]-- - MERGE -- Doc Not Found-Address Proof");
                }
    ...
    public static void ImageToPDF(List<String> inputFiles, String outputFile) {
        ...
        try {
            ...
            System.out.println("[MBL-SFTP-BL]-- - C Kyc Doc Write Exc- " + e);
        }
    }
    ...
    public void initiateSftp(propertyConfig configObj, Connection con, Map dataMap) {
        ...
        System.out.println("[MBL SFTP IP]--" + serverAddress);
        System.out.println("[MBL SFTP USERID]--" + userId);
        System.out.println("[MBL SFTP PASSWORD]--" + password);

        //PROD
        //remoteDirectory = "SERVOSYS/BPMDOCUPLOAD/IN24/";
        //UAT
        //remoteDirectory = "BACKLOG/BACKLOG1/IN/";
        System.out.println("[MBL SFTP REMOTE DIRECTORY]--" + remoteDirectory);
        //String localDirectory = "DMS_ARCHIVAL/NEW/";

        String localDirectory = "DMS_ARCHIVAL/MBL/BACKLOG_SFTP/";
        ...
        try {
            ...
            System.out.println("[MBL-SFTP-BL]--  Local Dir -" + localDirectory + fileToFTP);

            System.out.println("[MBL-SFTP-BL]-- - check if the file exists");
            String filepath = localDirectory + fileToFTP;
            File file = new File(filepath);
            if (!file.exists()) {
                throw new RuntimeException("MBL MERGE  Error. Local file not found");
            }

            System.out.println("[MBL-SFTP-BL]-- - Initializes the file manager");
            manager.init();

            System.out.println("[MBL-SFTP-BL]-- - Setup our SFTP configuration");
            ...
            System.out.println("[MBL-SFTP-BL]-- - Create the SFTP URI using the host name, userid, password,  remote path and file name");
            String sftpUri = "sftp://" + userId + ":" + password + "@" + serverAddress + "/"
                    + remoteDirectory + fileToFTP;

            System.out.println("[MBL-SFTP-BL]-- " + sftpUri);

            System.out.println("[MBL-SFTP-BL]-- Create local file object");
            FileObject localFile = manager.resolveFile(file.getAbsolutePath());

            System.out.println("[MBL-SFTP-BL]-- Create remote file object");
            FileObject remoteFile = manager.resolveFile(sftpUri, opts);

            System.out.println("[MBL-SFTP-BL]-- Copy local file to sftp server");
            remoteFile.copyFrom(localFile, Selectors.SELECT_SELF);
            System.out.println("[MBL-SFTP-BL]-- Folder upload successful");
            ...
            for (File item : subFiles) {
                ...
                System.out.println("[MBL-SFTP-BL]-- " + file.getAbsolutePath());
                localFile = manager.resolveFile(file.getAbsolutePath());
                remoteFile = manager.resolveFile(sftpUri, opts);
                if (item.isFile()) {
                    remoteFile.copyFrom(localFile, Selectors.SELECT_SELF);
                    System.out.println("MBL remoteDirectory:" + remoteDirectory);
                    System.out.println("MBL remoteDirectory remain:" + fileToFTP + File.separator + item.getName());
                    System.out.println("MBL remoteDirectory fileToFTP:" + fileToFTP);
                    System.out.println("MBL remoteDirectory item :" + item.getName());
                    cSftp.chmod(511, remoteDirectory + fileToFTP + "/" + item.getName());
                    System.out.println("[MBL-SFTP-BL]-- File upload successful");
                }
            }
            ...
            System.out.println("[MBL-SFTP-BL]-- Updating Flag.");
            if (updateFlag(con, dataMap.get("PROCESSINSTANCEID").toString(), "Upload", "")) {
                ...
                System.out.println("[MBL-SFTP-BL]--  Routing Done for - " + dataMap.get("PROCESSINSTANCEID").toString());
//                    File fileBkp = new File("DMS_ARCHIVAL" + File.separator + "MBL" + File.separator + "BACKLOG_SFTP" + File.separator + "EXT-" + dataMap.get("CUSTOMERID"));
//                    removeDirectory(fileBkp);
                ...
                if (directoryToDelete.exists()) {
                    ...
                    System.out.println("[MBL-SFTP-BL]--Directory Found -- Deleting Existing Folder After upload to sftp: " + "EXT-" + deletecustomerID);
                    // Delete the directory
                    deleteDirectory(directoryToDelete);
                } else {
                    // Directory doesn't exist
                    System.out.println("[MBL-SFTP-BL]--Directory does not exist.");
                }
                //}
//                }
            }
            ...
            updateFlag(con, dataMap.get("PROCESSINSTANCEID").toString(), "EXC", ex.getMessage());
            System.out.println("[MBL-SFTP-BL]-- SFTP Ex - " + ex);
        } finally {
            // CH-D-2001
            manager.close();
            channel.disconnect();
    ...
    public boolean updateFlag(Connection con, String pinstId, String type, String tempLocation) {
        ...
        try {
            if (type.equalsIgnoreCase("Copy")) {
                ...
                query = "UPDATE MBL_EXT SET UPLOADDOC_FLAG = ? ,  DOCPURGEFLAG='O' WHERE PINSTID = ?";
                pstmt = con.prepareStatement(query);
                pstmt.setString(1, "BYPASS");
                pstmt.setString(2, pinstId);

            } else if (type.equalsIgnoreCase("SKIP")) {
                query = "UPDATE MBL_BACKLOG_SFTP SET EXECUTION_FLAG = ? ,REMARKS=?,PROCESSED_AT = SYSDATE WHERE PINSTID = ?";
                pstmt = con.prepareStatement(query);
                pstmt.setString(1, "BYPASS");
                ...
                query = "UPDATE MBL_BACKLOG_SFTP SET EXECUTION_FLAG = ? ,REMARKS=?,PROCESSED_AT = SYSDATE WHERE PROCESSINSTANCEID = ?";
                pstmt = con.prepareStatement(query);
    ...
    public Map getDocuemntsDetails(Connection con, String strPinstid) {
        ...
        try {
            ...
            updateFlag(con, strPinstid, "EXC", e.getMessage());
            return dataProof;
        } finally {
            closeConnection(rs, pstmt);
        }
    ...
    public HashMap checkDMSSession(Connection con, int userId, propertyConfig config) {
        ...
        try {
            ...
            System.out.println("com.servo.mbldoc.MBLBacklogSFTP.checkDMSSession()");
        } finally {
            closeConnection(rs, pstmt);
        }
        return sessionMap;
