...
@TimerService
public class MFCkycUpload_Voter_Version {
    ...
    public void execute(Connection con) throws Exception {
        ...
        String getDMSUploadSql = "{call MF_CKYC_VOTER_VERSION(?,?)}";
        try {
...
//    }
    public void cKycupdate(Map<String, String> dataMap, Connection con, String pinstid) {
        ...
        try {
            ...
            String AddressProofType = HashCustProof.get("ADDRESS_PROOF_TYPE").toString();
            System.out.println("[MFCKYC-UPLOAD]-- AddressProoftype---" + AddressProofType);
            System.out.println("[MFCKYC-UPLOAD]-- Completed the CKYC Documents Chages");
            ...
            //String StrVal = "MF Primary Id,MF Corrs Id,MF Bank Passbook";
            if (dataMap.get("EKYCFLAG").equalsIgnoreCase("Y")) {
            ...
            for (String strTemp : arrSplit) {
                ...
                if (testFile.exists()) {
                    ...
                    System.out.println("[MFCKYC-UPLOAD]--FILE NOT FOUND: " + testFile.getName());
                }
            ...
            System.out.println("[MFCKYC-UPLOAD]-- Updating File not found");
            updateFlag(con, dataMap.get("PROCESSINSTANCEID"), "ERR", "File is not created");
            System.out.println("[MFCKYC-UPLOAD]-- EXCEPTION: " + fx.getMessage());
        } catch (IOException ex) {
            System.out.println("[MFCKYC-UPLOAD]-- CKyc Ex- " + ex);
            ex.printStackTrace();
        }
    }
